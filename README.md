...
The pipeline is unit-tested (86 tests) and replay-benchmarked on eight repos (clap and tokio added in 0.9.0); the Action and MCP server are exercised end-to-end in CI.
